...
INSERT INTO `filmes` VALUES 
    ...
    (28,'Harry Potter e o Prisioneiro de Azkabam','Ficção e Fantasia',142,2004,1.69),
    ...
    (38,'A casa do lago','Drama',99,2006,2.49),
    (39,'Não estou lá','Drama',135,2007,1.79),
    (40,'Quando Me Apaixono','Drama',100,2007,1.99),
    (41,'O Reino','Drama',110,2007,2.09),
    (42,'Onde os Fracos Não Têm Vez','Drama',122,2007,1.49),
    (43,'Invasores','Mistério e Suspense',99,2007,2.09),
    (44,'Harry Potter e a Ordem da Fênix','Ficção e Fantasia',138,2007,2.49),
    (45,'Queime Depois de Ler','Drama',96,2008,2.39),
    (46,'Sleepwalking','Drama',101,2008,1.79),
    (47,'Um Amor de Tesouro','Ação e Aventura',112,2008,2.69),
    (48,'Astro Boy','Ação e Aventura',94,2009,2.89),
    (49,'Harry Potter e o Enigma do Príncipe','Ficção e Fantasia',153,2009,1.59),
    (50,'Inverno da Alma','Drama',100,2010,2.69),
    (51,'Uma Manhã Gloriosa','Comédia',107,2010,2.99),
    (52,'Jogo de Poder','Drama',108,2010,2.89),
    (53,'O Vencedor','Ação e Aventura',116,2010,2.49),
    (54,'Harry Potter e as Relíquias da Morte: Parte 1','Ficção e Fantasia',146,2010,2.79),
    (55,'Mulheres ao Ataque','Drama',102,2011,1.69),
    (56,'Cada Um Tem a Gêmea Que Merece','Comédia',91,2011,2.09),
    (57,'Jovens Adultos','Drama',94,2011,1.99),
    (58,'Histórias Cruzadas','Drama',146,2011,2.49),
    (59,'Pior dos Pecados','Mistério e Suspense',111,2011,2.39),
    (60,'Morte Negra','Drama',102,2011,2.69),
    (61,'Harry Potter e as Relíquias da Morte: Parte 2','Ficção e Fantasia',130,2011,1.99),
    (62,'As Sessões','Drama',95,2012,2.29),
    (63,'Django Livre','Ação e Aventura',165,2012,2.69),
    (64,'A Viagem','Drama',172,2012,2.89),
    (65,'Motoqueiro Fantasma - Espírito de Vingança','Ação e Aventura',96,2012,1.79),
    (66,'Jogos Vorazes','Drama',142,2012,1.59),
    (67,'O Ataque','Drama',131,2013,1.59),
    (68,'Sem proteção','Mistério e Suspense',125,2013,2.39),
    (69,'Sangue no Gelo','Mistério e Suspense',105,2013,2.49),
    (70,'Capitão Phillips','Drama',134,2013,1.59),
    (71,'Rio 2','Animação',101,2014,1.79);
